...
for i = 1:1
    ...
    function problem_instance_OA(solver)
        ...
        @constraint(m, e79, -0.9 * x[39] + x[44] + 500 * b[92] <= 500)
        @constraint(m, e80, -0.95 * x[39] + x[44] + 500 * b[93] <= 500)
        @constraint(m, e81, -0.9 * x[39] + x[44] + 500 * b[94] <= 500)
        @constraint(m, e82, -0.95 * x[39] + x[44] + 500 * b[95] <= 500)
        ...
        @constraint(m, e87, -0.85 * x[47] + x[48] + 100.0 * b[96] <= 100.0)
        @constraint(m, e88, -0.98 * x[47] + x[48] + 100.0 * b[97] <= 100.0)
        @constraint(m, e89, -0.85 * x[47] + x[48] + 100.0 * b[98] <= 100.0)
        @constraint(m, e90, -0.98 * x[47] + x[48] + 100.0 * b[99] <= 100.0)
        @constraint(m, e91, -0.85 * x[47] + x[49] + 100.0 * b[96] <= 100.0)
        @constraint(m, e92, -0.98 * x[47] + x[49] + 100.0 * b[97] <= 100.0)
        @constraint(m, e93, -0.85 * x[47] + x[49] + 100.0 * b[98] <= 100.0)
        @constraint(m, e94, -0.98 * x[47] + x[49] + 100.0 * b[99] <= 100.0)
        @constraint(m, e95, -0.85 * x[47] + x[48] - 100.0 * b[96] >= -100.0)
        @constraint(m, e96, -0.98 * x[47] + x[48] - 100.0 * b[97] >= -100.0)
        @constraint(m, e97, -0.85 * x[47] + x[48] - 100.0 * b[98] >= -100.0)
        @constraint(m, e98, -0.98 * x[47] + x[48] - 100.0 * b[99] >= -100.0)
        @constraint(m, e99, -0.85 * x[47] + x[49] - 100.0 * b[96] >= -100.0)
        @constraint(m, e100, -0.98 * x[47] + x[49] - 100.0 * b[97] >= -100.0)
        @constraint(m, e101, -0.85 * x[47] + x[49] - 100.0 * b[98] >= -100.0)
        @constraint(m, e102, -0.98 * x[47] + x[49] - 100.0 * b[99] >= -100.0)
        ...
        @constraint(m, e135, -0.85 * x[60] + x[63] + 10.0 * b[112] <= 10.0)
        @constraint(m, e136, -0.95 * x[60] + x[63] + 10.0 * b[113] <= 10.0)
        @constraint(m, e137, -0.85 * x[60] + x[63] + 10.0 * b[114] <= 10.0)
        @constraint(m, e138, -0.95 * x[60] + x[63] + 10.0 * b[115] <= 10.0)
        ...
        @constraint(m, e143, -0.8 * x[66] + x[67] + 2.0 * b[116] <= 2.0)
        @constraint(m, e144, -0.92 * x[66] + x[67] + 2.0 * b[117] <= 2.0)
        @constraint(m, e145, -0.8 * x[66] + x[67] + 2.0 * b[118] <= 2.0)
        @constraint(m, e146, -0.92 * x[66] + x[67] + 2.0 * b[119] <= 2.0)
        @constraint(m, e147, -0.8 * x[66] + x[67] - 2.0 * b[116] >= -2.0)
        @constraint(m, e148, -0.92 * x[66] + x[67] - 2.0 * b[117] >= -2.0)
        @constraint(m, e149, -0.8 * x[66] + x[67] - 2.0 * b[118] >= -2.0)
        @constraint(m, e150, -0.92 * x[66] + x[67] - 2.0 * b[119] >= -2.0)
        ...
        @constraint(m, e247, 4 * x[2] + 8 * x[7] + 5 * x[11] + 8 * x[23] + 10 * x[30] + x[80] + x[81] + x[82] + x[83] + x[84] + x[85] + x[86] + x[87] <= 40000.0)
    ...
    function problem_instance_BB(solver)
        ...
        @constraint(m, e193, x[82] + 7 * b[130] <= 22.0)
        @constraint(m, e194, x[82] <= 22.0)
        @constraint(m, e195, x[83] + 24 * b[132] <= 0)
        @constraint(m, e196, x[83] + 13 * b[133] <= 0)
        @constraint(m, e197, x[83] + 11 * b[134] <= 0)
        @constraint(m, e198, x[83] <= 24.0)
        @constraint(m, e199, x[84] + 23 * b[136] <= 23.0)
        @constraint(m, e200, x[84] + 13 * b[137] <= 23.0)
        @constraint(m, e201, x[84] + 10 * b[138] <= 23.0)
